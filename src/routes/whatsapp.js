...
const { handleIncomingMessage, setBotActive, isBotActive, setBotMode, getBotMode } = require('../whatsapp/handler');
...
router.get('/status', (req, res) => {
  ...
  res.json({ sessionId: activeSession, connected, botActive: isBotActive(), botMode: getBotMode() });
});
